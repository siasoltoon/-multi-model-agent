...
def build_provider_adapter(provider_id: str, *, model: str, timeout: float = 180.0) -> OpenAICompatibleAdapter:
    ...
    if not api_key:
        raise RuntimeError(f"missing provider credential: {api_key_env or provider_id}")
